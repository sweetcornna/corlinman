...
export const zhCN = {
  ...
  dashboard: {
    ...
    tp: {
      greeting: "{{name}}，下午好 —",
      operatorFallback: "管理员",
      agentsAre: "Agent 状态",
      quiet: "正常",
      attending: "需处理",
      waiting: "待审批",
      leadPill: "{{systems}} 个子系统正常",
      summaryLead: "{{agents}} 个 Agent ·",
      summaryPluginsSuffix: "插件已加载。",
      summaryChunksSuffix: "RAG 分片已索引。",
      pendingApprovals: "{{n}} 个待审批",
      summaryApprovalsSuffix: "待处理。",
      ctaPalette: "打开命令面板",
      ctaReview: "处理 {{n}} 个审批",
      ctaLogs: "查看日志",
      uptimeLabel: "可用性",
  ...
  schedulerQzone: {
    ...
    cancelEdit: "取消编辑",
    personaLockedHint:
      "已有任务的人格不可更改。如需更换人格，请删除此任务后重新新建。",
    enabledEditHint: "启用或暂停请使用任务列表中该行的暂停/恢复按钮。",
    jitterLabel: "发送抖动（分钟）",
    jitterHint:
      "在触发时间上随机 ± 这么多分钟（0–120），让发布看起来更自然。",
    deleteTitle: "删除该每日说说任务？",
    deleteBody: "确定删除 {{name}}？此操作不可撤销。",
    deleted: "已删除 {{name}}",
    deleteFail: "删除失败：{{msg}}",
    paused: "已暂停 {{name}}",
    resumed: "已恢复 {{name}}",
    toggleFail: "暂停/恢复失败：{{msg}}",
    refresh: "刷新",
    ...
    triggeredNoUrl: "{{name}} 运行成功",
    triggerFailed: "{{name}} 失败：{{err}}",
    triggerError: "无法触发 {{name}}：{{msg}}",
    col: {
      name: "名称",
      persona: "人格",
      cron: "Cron",
    ...
    row: {
      ...
      error: "出错",
      runNow: "立即运行",
      viewQzone: "在 QZone 查看",
      edit: "编辑",
      pause: "暂停",
      resume: "恢复",
      delete: "删除",
      configReadonly: "配置任务（来自 TOML）—— 此处只读。",
    },
    schedule: {
      modeDaily: "每天",
      modeWeekly: "每周",
    ...
    refs: {
      title: "参考配图",
      help: "人格发布说说时作为立绘附带。",
      pickPersonaFirst: "请先选择人格以加载其参考配图。",
      empty: "暂无参考配图 —— 上传一张即可附带。",
      upload: "上传",
      uploadOk: "已上传 {{label}}",
      uploadFail: "上传失败：{{msg}}",
      selectedCount: "已选 {{count}} 张",
      capHint: "模型只会看到前 {{cap}} 张。",
      missing: "引用的素材已被删除 —— 点击移除。",
      deleteTitle: "删除参考配图？",
      deleteBody: "确定删除「{{label}}」？此操作不可撤销。",
      deleted: "已删除 {{label}}",
      deleteFail: "删除失败：{{msg}}",
    },
    reply: {
  ...
  qqMonitor: {
    title: "群消息监控与定时汇总",
    lede: "一个任务可监控多个群（或群内指定成员），支持重点关注特定成员，按计划把汇总发到群或私聊。",
    addRule: "新增监控任务",
    save: "保存",
    saved: "监控任务已保存",
    saveFailed: "保存失败：{{msg}}",
    conflict: "配置已被别处修改，已刷新，请重新编辑后再保存。",
    unsaved: "有未保存的修改 —— 点击保存后生效。",
    loadFailed: "监控任务加载失败。",
    noRules: "暂无监控任务",
    noRulesHint: "点击「新增监控任务」创建第一个群消息监控。",
    triggered: "已触发试发，请稍后查看目标会话。",
    triggerOffline: "渠道离线或监控未激活，无法试发。",
    triggerFailed: "试发失败：{{msg}}",
    deleteTitle: "删除该监控任务？",
    deleteBody: "确定删除 {{id}}？点击顶部保存后才会真正生效。",
    mergeSelected: "合并所选（{{n}}）",
    merged: "已合并到 {{id}}，保存后生效。",
    mergeTooMany: "合并后监控源超过 {{max}} 个，无法合并。",
    row: {
      watchAll: "全群成员",
      watchSome: "{{n}} 人",
      focus: "重点关注 {{n}} 人",
      ...
      delete: "删除",
      enableAria: "启用任务 {{id}}",
      selectAria: "选择任务 {{id}} 参与合并",
    },
    form: {
      createTitle: "新增监控任务",
      editTitle: "编辑任务 {{id}}",
      idLabel: "任务 ID",
      idHint: "小写字母或数字开头，可含 - 和 _，保存后不可修改。",
      idInvalid: "ID 只能用小写字母、数字、- 和 _，且以字母或数字开头。",
      idTaken: "该 ID 已存在。",
      sourcesLabel: "监控源",
      sourceTitle: "监控源 {{n}}",
      addSource: "添加监控源",
      removeSourceAria: "移除监控源 {{n}}",
      groupLabel: "群号",
      groupInvalid: "群号必须是纯数字。",
      groupDuplicate: "同一任务内群号不能重复。",
      watchLabel: "采集范围",
      watchAll: "全部成员",
      watchSome: "仅指定成员",
      watchHint: "仅指定成员时只统计这些 QQ 号的发言（重点关注成员除外）。",
      watchInputPlaceholder: "输入 QQ 号后回车添加",
      watchRemoveAria: "移除 {{id}}",
      focusLabel: "重点关注",
      focusHint: "重点关注成员总会被采集（即使采集范围收窄），汇总会在末尾为每位重点关注对象单独详述。",
      focusInputPlaceholder: "输入重点关注的 QQ 号后回车",
      focusRemoveAria: "移除重点关注 {{id}}",
      scheduleLabel: "定时方式",
      scheduleDaily: "每天定时",
      scheduleInterval: "固定间隔",
      dailyTimeLabel: "每天时间",
      dailyTimeInvalid: "请填写 HH:MM 格式的时间。",
      intervalLabel: "间隔（分钟）",
      intervalHint: "最少 5 分钟。",
      intervalInvalid: "间隔必须是不小于 5 的整数分钟。",
      windowLabel: "汇总窗口（分钟）",
      windowHint: "0 = 自动（每天 → 1440，间隔 → 与间隔相同）。",
      windowInvalid: "窗口必须是不小于 0 的整数分钟。",
      timezoneLabel: "时区",
      timezoneHint: "IANA 时区名，留空使用服务端默认。",
      targetLabel: "投递目标",
      targetGroup: "发到群",
      targetUser: "私聊",
      targetIdLabel: "目标号码",
      targetIdInvalid: "目标号码必须是纯数字。",
      styleLabel: "附加风格要求",
      styleHint: "内置风格为「精简说人话、冷静客观」，此处只写追加要求。",
      stylePlaceholder: "例如：多用短句，重点标出待办事项。",
      sendWhenEmptyLabel: "窗口无消息时也发送提示",
      cancel: "取消",
      applyCreate: "添加到列表",
      applyEdit: "更新任务",
    },
  ...
  authz: {
    title: "权限策略",
    subtitle:
      "统一授权模型：策略规则与已记住的授权。单次工具审批在「审批」页处理。",
    policy: {
      title: "策略编辑器",
      hint: "编辑 [permissions] 配置段。保存会同时改写 config.toml 与 agent sidecar，下一回合生效。",
      save: "保存策略",
      saving: "保存中…",
      saved: "策略已保存，下一回合生效。",
      saveFailed: "保存失败：{{msg}}",
      ...
      addRule: "新增规则",
      removeRuleAria: "删除规则",
      noRules: "还没有规则——可以新增一条，或留空回退到模式 / 默认动作。",
      tool: "工具",
      action: "动作",
      memory: "记忆",
      note: "备注",
      notePlaceholder: "会出现在审计日志中",
      scopeSurface: "surface",
      scopeUser: "user",
      scopeSession: "session",
      scopeModel: "model",
      scopeTenant: "tenant",
      effectHint: "规则按顺序匹配（默认后匹配优先）。作用域留空表示不限。",
    },
    grants: {
      title: "授权记录",
      hint: "交互审批中记住的持久（always）授权。撤销后在 agent 下一次权限检查时生效。",
      loadFailed: "无法加载授权记录。",
      empty: "暂无持久授权。",
      colTool: "工具",
      colTenant: "租户",
      ...
      unsynced: "（仅内存）",
      revoke: "撤销",
      revokeConfirm: "撤销 {{tool}} 的这条持久授权？下次匹配调用将重新询问。",
      revokeFailed: "撤销失败：{{msg}}",
      effectHint: "授权只能收窄 ask 规则——永远不能突破 deny 规则。",
    },
  },
  ...
  providers: {
    ...
    fieldEnabled: "启用",
    modelsTitle: "可用模型",
    modelsHint: "根据当前表单拉取模型列表，不会保存 provider。",
    modelsFetch: "获取模型",
    modelsFetching: "获取中…",
    modelsEmpty: "尚未获取模型。",
    modelsFetchFailed: "获取模型失败: {{msg}}",
  ...
  modelHub: {
    ...
    capabilities: {
        ...
        disabled: "已关闭",
        unlisted: "（未列出）",
        editInRouting: "到路由页编辑",
        editInVoice: "编辑并试听",
        inheritChat: "（沿用对话 Provider）",
        imageModelPlaceholder: "例如 gpt-image-2",
        imageHint: "两项都留空则沿用对话 Provider，与此前行为一致。",
        search: "联网搜索",
        backend: "后端",
        apiKey: "API Key",
        searchDefault: "DuckDuckGo（免密钥）",
        searchSaved: "搜索绑定已保存",
        keyStored: "已配置——留空则保持不变",
        keyNone: "未配置",
        searchHint: "不配密钥时走 DuckDuckGo 网页抓取，会被限流、也可能失效。",
        intro: "各能力实际使用的模型。persona 绑定优先于这里的默认值，这里的默认值优先于对话 Provider。",
        loadFailed: "无法加载能力绑定。",
    },
    advanced: {
      warning:
  ...
  // PR5 引导式接入流程 —— /models 快速接入弹窗、onboarding 第一步、
  // 仪表盘 getting-started 卡片三处共用。
  setupFlow: {
    quickSetup: "快速接入",
    dialogTitle: "快速接入模型服务",
    dialogDesc: "五步完成：选择服务商 → 认证 → 测试 → 选模型 → 设默认。",
    emptyStateTitle: "还没有接入任何模型服务",
    emptyStateBody: "按引导完成接入，即可开始聊天。",
    onboardSubtitle: "接入一个模型服务商，完成后即可继续。也可以先跳过。",
    loading: "正在检查当前配置…",
    backendPending: "网关暂不可用——可以先跳过，稍后在控制台完成配置。",
    configuredTitle: "已配置 ✓",
    configuredSummary: "当前已接入 {{provider}}，默认模型 {{model}}。",
    step1Title: "选择服务商",
    step2Title: "认证",
    step3Title: "测试连接",
    step4Title: "选择模型",
    ...
    fieldName: "Provider 名称",
    fieldBaseUrl: "Base URL",
    fieldKey: "API Key",
    fieldKeyPlaceholder: "sk-…（仅保存到网关配置，不会上传别处）",
    fieldEnv: "环境变量名",
    useEnvVar: "改用环境变量",
    useLiteralKey: "改为直接输入 Key",
    oauthHint: "有订阅账号？OAuth 登录后会自动接入模型并设好默认。",
    oauthLogin: "OAuth 登录",
    oauthProvisioned: "OAuth 登录成功——模型已自动接入。",
    next: "继续",
    back: "上一步",
    probeHint: "点击测试连接，并从服务商拉取可用模型列表。",
    probeBtn: "测试并获取模型",
    probing: "正在连接…",
    probeFailedHint: "请检查 API Key / Base URL 是否正确，然后重试。",
    probeEmpty: "连接成功但未发现可用模型。",
    selectAll: "全选",
    selectedCount: "已选 {{n}} 个",
    addModels: "添加所选模型 ({{n}})",
    adding: "添加中…",
    defaultHint: "选择聊天默认使用的模型。",
    currentDefault: "当前默认",
    noAliases: "还没有可选的模型别名。",
    saveDefault: "保存默认模型",
    saving: "保存中…",
    defaultSaveFailed: "保存默认模型失败: {{msg}}",
    doneTitle: "配置完成",
    doneBody: "已接入 {{provider}}，默认模型 {{model}}。可以开始聊天了。",
    finish: "完成",
  },

  // PR5 仪表盘 getting-started 卡片。
  gettingStarted: {
    title: "快速开始",
    body: "三步接入模型服务，即可开始聊天。",
    itemProvider: "接入 Provider",
    itemModels: "添加模型",
    itemDefault: "设置默认模型",
    goToModels: "前往「模型与密钥」",
    dismiss: "隐藏",
  ...
  chat: {
    ...
    statusIdle: "空闲",
    questionSubmit: "发送",
    questionMultipleHint: "可多选,选好后点发送",
    loadEarlier: "加载更早的消息",
    messageLogAriaLabel: "对话消息",
    loadingEarlier: "加载中…",
    stopping: "正在停止…",
    stoppedByUser: "已停止",
    ...
    editSaving: "保存中…",
    export: "导出",
    exportAriaLabel: "导出对话为 Markdown",
    ...
    reasoningEffortAriaLabel: "思考强度",
    reasoningEffortLabel: "思考",
    reasoningEffortNone: "关",
    reasoningEffortMinimal: "微",
    reasoningEffortLow: "低",
    reasoningEffortOn: "开",
    reasoningEffortMedium: "中",
    reasoningEffortHigh: "高",
    reasoningEffortXHigh: "超",
    reasoningEffortMax: "极",
  ...
  channelConfig: {
    ...
    listHint: "多个值用逗号分隔。",
    managed: "自动检测",
    managedPlaceholder: "登录 QQ 后自动识别",
    hint: {
    ...
    field: {
      ...
      monitor_retention_hours: "监控消息保留（小时）",
    },
  },
  ...
  system: {
    ...
    upgrade: {
      ...
      progress: {
        ...
        restarting: "正在重启网关…",
        waitingVersion: "正在重启——等待 v{{version}} 上线…",
        slow: "耗时比平常长。可以继续等待，或立即重新加载。",
        reloadNow: "立即重新加载",
        elapsed: "已用时 {{seconds}}秒",
        cancel: "停止观察",
        cancelHint: "若升级尚未开始应用则会取消；否则仅关闭此视图。",
      },
      phases: {
        validating: "校验中",
        pulling: "拉取镜像",
      ...
      cancelled: {
        ...
        aborted: "已取消升级",
        tooLate: "升级已进入应用阶段，无法取消——已改为停止观察。",
      },
      failed: {
        title: "升级失败",
        subtitle: "{{error}}",
    ...
    badge: {
      ...
      checkNow: "检查更新",
      throttled: "检查更新限每分钟一次。",
      updateAvailable: "{{tag}} 可用",
      updateNow: "立即更新",
      starting: "启动中…",
      details: "详情",
      manage: "更新与回滚",
      unavailable: "此部署不支持一键升级——请使用手动命令。",
    },
    rollback: {
      title: "回滚",
      subtitle: "当前运行 v{{current}}。可恢复到较早的版本。",
      action: "回滚",
      instant: "秒回",
      instantHint: "上一个容器仍保留在本机——恢复无需下载。",
      confirmTitle: "回滚到 {{tag}}？",
      confirmBody:
        "网关将重启到 {{tag}}（当前 v{{current}}）。数据保留，之后可再次升级。",
      confirm: "回滚",
      cancel: "取消",
      alreadyRunning: "已有升级正在进行。",
    },
    audit: {
      title: "升级历史",
      subtitle: "近期网关升级事件。",

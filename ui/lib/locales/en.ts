...
export const en = {
  ...
  qqMonitor: {
    ...
    lede: "Watch a group (or specific members) and deliver an LLM digest to a group or private chat on a schedule.",
    addRule: "Add rule",
    save: "Save",
    saved: "Monitor rules saved",
    saveFailed: "Save failed: {{msg}}",
    ...
    noRules: "No monitor rules yet",
    noRulesHint: "Click \"Add rule\" to create your first group monitor.",
    ...
    deleteTitle: "Delete this monitor rule?",
    ...
    row: {
      ...
      edit: "Edit",
      delete: "Delete",
      enableAria: "Enable rule {{id}}",
    },
    form: {
      createTitle: "New monitor rule",
      ...
      groupLabel: "Group number to watch",
      groupInvalid: "Group number must be digits only.",
      watchLabel: "Who to watch",
      watchAll: "All members",
      watchSome: "Selected members",
      watchHint: "With selected members, only messages from these QQ ids are captured.",

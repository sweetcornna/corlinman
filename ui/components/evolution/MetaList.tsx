...
function MetaTabBanner() {
  ...
  return (
    ...
    >
      <Sparkles className="mt-0.5 h-4 w-4 shrink-0 text-sg-accent" aria-hidden />
      <div className="flex flex-col gap-0.5">
        <span className="font-mono text-[10.5px] uppercase tracking-[0.08em] text-sg-accent">
          {t("evolution.tp.metaSelfImprovement")}
        </span>
        <span className="text-[12px] leading-[1.55] text-sg-ink-2">
  ...
  return (
    <GlassPanel
      ...
      className={cn(
        ...
        "border-l-[3px] border-l-sg-accent/70",
        "hover:-translate-y-[1px] hover:shadow-sg-3 hover:border-sg-accent/40",
      )}
...
function StatusBadge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center gap-1 rounded-full border px-2 py-[2px]",
        "border-sg-border bg-sg-inset-strong text-sg-ink-3",
        "font-mono text-[10.5px] uppercase tracking-[0.08em]",
      )}
    >
      {status}
...
function MetaEmpty() {
  ...
  return (
    ...
    >
      ...
      <p className="text-[13px] leading-[1.55] text-sg-ink-2">

...
import { Loader2, QrCode, RefreshCw } from "@/components/icons";
...
export function QqHero({
  ...
  return (
    <GlassPanel variant="strong" as="section" className="relative overflow-hidden p-7">
      {/* Ambient cyan accent glow (bottom-right). */}
      <div
        aria-hidden
      ...
      />
      {/* Secondary violet glow (top-left). */}
      <div
        aria-hidden
      ...
      <div className="relative flex min-w-0 flex-col gap-4">
        ...
        <h2 className="text-balance font-sans text-[28px] font-semibold leading-[1.15] tracking-[-0.025em] text-sg-ink sm:text-[32px]">
        ...
        <div className="mt-1 flex flex-wrap items-center gap-2.5">
          ...
          <button
            ...
            className={cn(
              "inline-flex items-center gap-2 rounded-sg-md border px-3 py-2 text-[13px] font-medium",
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-sg-md border border-sg-border bg-sg-inset px-3 py-2 text-[13px] font-medium text-sg-ink-2 transition-colors hover:bg-sg-inset-hover hover:text-sg-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sg-accent/40"
          >

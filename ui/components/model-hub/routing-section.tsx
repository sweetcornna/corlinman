...
/**
 * Model routing section — provider overview cards + the alias routing
 * table (default-model input, inline alias editing, per-alias params
 * editor, model picker) + save logic.
 *
 * Extracted from `app/(admin)/models/page.tsx` (PR4 model-hub
 * consolidation). Behavior preserved verbatim, including the dual v1/v2
 * backend shape handling:
 *
 * v0.1 behaviour: `aliases: Record<string, alias-target>` edited inline,
 * saved via `POST /admin/models/aliases { aliases, default }`.
 *
